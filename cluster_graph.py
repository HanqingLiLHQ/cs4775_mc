...
cluster_h = hierarchical_clustering.hierarchical_clustering(
    num_clusters, dm, idlist, distance_update="complete"
)
cluster_h = sort_sublists(cluster_h)
print(cluster_h)
print("Finish printing result by hierarchical clustering \n")

cluster_match_h = most_similar_lists(dataset_cc_list, cluster_h)

base_dir_clusters_h = "hierarchical_clusters"
cluster_generator_h = cluster_graph.ClusterGraphGenerator(
    cluster_match_h, base_dir_motifs, base_dir_clusters_h
)
cluster_paths_our = cluster_generator_h.generate_cluster_graphs()
final_graph.generate_final_composite_graph(base_dir_clusters_h, cluster_paths_our)

#####################################################################

# Clusrer M Graph

cluster_m = kmeans_hier_init.kmeans_motifs(dm, idlist, num_clusters)
cluster_m = sort_sublists(cluster_m)
print(cluster_m)
print("Finish printing result by kmeans clustering \n")

cluster_match_m = most_similar_lists(dataset_cc_list, cluster_m)

base_dir_clusters_m = "kmeans_clusters"
cluster_generator_m = cluster_graph.ClusterGraphGenerator(
    cluster_match_m, base_dir_motifs, base_dir_clusters_m
)
cluster_paths_our = cluster_generator_m.generate_cluster_graphs()
final_graph.generate_final_composite_graph(base_dir_clusters_m, cluster_paths_our)
...
cluster_hmm = sort_sublists(cluster_hmm)
print(cluster_hmm)
print("Finish printing result by hierarchical clustering \n")

cluster_match_hmm = most_similar_lists(dataset_cc_list, cluster_hmm)
print(cluster_match_hmm)
print("Finish printing result by matching \n")

base_dir_clusters_our = "hmm_clusters"
cluster_generator_our = cluster_graph.ClusterGraphGenerator(
    cluster_match_hmm, base_dir_motifs, base_dir_clusters_our
)
